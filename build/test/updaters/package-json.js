...
(0, mocha_1.describe)('PackageJson', () => {
    (0, mocha_1.describe)('updateContent', () => {
        ...
        (0, mocha_1.it)('updates dependency versions', async () => {
            const oldContent = (0, fs_1.readFileSync)((0, path_1.resolve)(fixturesPath, './package-with-dependencies.json'), 'utf8');
            const versionsMap = new Map();
            versionsMap.set('camelcase', version_1.Version.parse('6.0.0'));
            versionsMap.set('chai', version_1.Version.parse('4.2.1'));
            versionsMap.set('foo', version_1.Version.parse('0.1.0'));
            versionsMap.set('bar', version_1.Version.parse('2.3.4'));
            const packageJson = new package_json_1.PackageJson({
                version: version_1.Version.parse('14.0.0'),
                versionsMap,
            });

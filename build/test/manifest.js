...
(0, mocha_1.describe)('Manifest', () => {
    ...
    (0, mocha_1.describe)('fromManifest', () => {
        ...
        (0, mocha_1.it)('should read plugins from manifest', async () => {
            const getFileContentsStub = sandbox.stub(github, 'getFileContentsOnBranch');
            getFileContentsStub
                .withArgs('release-please-config.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileContent)(fixturesPath, 'manifest/config/node-workspace-plugins.json'))
                .withArgs('.release-please-manifest.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileContent)(fixturesPath, 'manifest/versions/versions.json'));
            const manifest = await manifest_1.Manifest.fromManifest(github, github.repository.defaultBranch);
            (0, chai_1.expect)(manifest.plugins).lengthOf(1);
            (0, chai_1.expect)(manifest.plugins[0]).instanceOf(node_workspace_1.NodeWorkspace);
            const workspacePlugin = manifest.plugins[0];
            (0, chai_1.expect)(workspacePlugin.updatePeerDependencies).to.be.true;
        });
        ...
        (0, mocha_1.it)('should consider draft-pull-requests', async () => {
            const getFileContentsStub = sandbox.stub(github, 'getFileContentsOnBranch');
            getFileContentsStub
                .withArgs('release-please-config.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileContent)(fixturesPath, 'manifest/config/draft-pull-request.json'))
                .withArgs('.release-please-manifest.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileContent)(fixturesPath, 'manifest/versions/versions.json'));
            const manifest = await manifest_1.Manifest.fromManifest(github, github.repository.defaultBranch);
            (0, chai_1.expect)(manifest.repositoryConfig['.'].draftPullRequest).to.be.true;
            (0, chai_1.expect)(manifest.repositoryConfig['node-packages'].draftPullRequest).to.be
                .false;
        });
    });
    ...
    (0, mocha_1.describe)('buildPullRequests', () => {
        (0, mocha_1.describe)('with basic config', () => {
            ...
            (0, mocha_1.it)('allows customizing pull request footer', async () => {
                const manifest = new manifest_1.Manifest(github, 'main', {
                    '.': {
                        releaseType: 'simple',
                ...
                (0, chai_1.expect)(pullRequests).lengthOf(1);
                const pullRequest = pullRequests[0];
                (0, chai_1.expect)(pullRequest.body.footer.toString()).to.eql('No reminder for you');
            });
        });
        ...
        (0, mocha_1.describe)('with multiple packages', () => {
            (0, mocha_1.beforeEach)(() => {
                (0, helpers_1.mockReleases)(sandbox, github, [
                    {
                        id: 123456,
            ...
            (0, mocha_1.it)('should handle pull request header/footer with multiple packages', async () => {
                const manifest = new manifest_1.Manifest(github, 'main', {
                    'path/a': {
                        releaseType: 'simple',
                        component: 'pkg1',
                ...
                (0, chai_1.expect)(pullRequests).lengthOf(1);
                const pullRequest = pullRequests[0];
                (0, chai_1.expect)(pullRequest.body.header.toString()).to.eql('Header from pkg1');
                (0, chai_1.expect)(pullRequest.body.footer.toString()).to.eql('Footer from pkg2');
            });
        });
    ...
    (0, mocha_1.describe)('buildReleases', () => {
        ...
        (0, mocha_1.it)('should handle customized group pull request title', async () => {
            mockPullRequests(github, [], [
                {
                    headBranchName: 'release-please/branches/main',
                    baseBranchName: 'main',
            ...
            getFileContentsStub
                .withArgs('package.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileRaw)(JSON.stringify({ name: '@google-automations/all' })))
                .withArgs('packages/bot-config-utils/package.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileRaw)(JSON.stringify({ name: '@google-automations/bot-config-utils' })))
                .withArgs('packages/label-utils/package.json', 'main')
                .resolves((0, helpers_1.buildGitHubFileRaw)(JSON.stringify({ name: '@google-automations/label-utils' })))
            ...
            // 3.3.0
            (0, chai_1.expect)(releases[0].tag.toString()).to.eql('v3.3.0');
            (0, chai_1.expect)(releases[0].sha).to.eql('abc123');
            (0, chai_1.expect)(releases[0].notes)
                .to.be.a('string')
                .and.satisfy((msg) => msg.startsWith('### Features'));
            (0, chai_1.expect)(releases[0].path).to.eql('.');
            (0, chai_1.expect)(releases[0].name).to.eql('v3.3.0');
            // @google-automations/bot-config-utils: 3.2.0
            (0, chai_1.expect)(releases[1].tag.toString()).to.eql('bot-config-utils-v3.2.0');
            (0, chai_1.expect)(releases[1].sha).to.eql('abc123');
            (0, chai_1.expect)(releases[1].notes)
                .to.be.a('string')
                .and.satisfy((msg) => msg.startsWith('### Features'));
            (0, chai_1.expect)(releases[1].path).to.eql('packages/bot-config-utils');
            (0, chai_1.expect)(releases[1].name).to.eql('bot-config-utils: v3.2.0');
            // @google-automations/label-utils: 1.1.0
            (0, chai_1.expect)(releases[2].tag.toString()).to.eql('label-utils-v1.1.0');
            (0, chai_1.expect)(releases[2].sha).to.eql('abc123');
            (0, chai_1.expect)(releases[2].notes)
                .to.be.a('string')
                .and.satisfy((msg) => msg.startsWith('### Features'));
            (0, chai_1.expect)(releases[2].path).to.eql('packages/label-utils');
            (0, chai_1.expect)(releases[2].name).to.eql('label-utils: v1.1.0');
            // @google-automations/object-selector: 1.1.0
            (0, chai_1.expect)(releases[3].tag.toString()).to.eql('object-selector-v1.1.0');
            (0, chai_1.expect)(releases[3].sha).to.eql('abc123');
            (0, chai_1.expect)(releases[3].notes)
                .to.be.a('string')
                .and.satisfy((msg) => msg.startsWith('### Features'));
            (0, chai_1.expect)(releases[3].path).to.eql('packages/object-selector');
            (0, chai_1.expect)(releases[3].name).to.eql('object-selector: v1.1.0');
            // @google-automations/datastore-lock: 2.1.0
            (0, chai_1.expect)(releases[4].tag.toString()).to.eql('datastore-lock-v2.1.0');
            (0, chai_1.expect)(releases[4].sha).to.eql('abc123');
            (0, chai_1.expect)(releases[4].notes)
                .to.be.a('string')
                .and.satisfy((msg) => msg.startsWith('### Features'));
            (0, chai_1.expect)(releases[4].path).to.eql('packages/datastore-lock');
            (0, chai_1.expect)(releases[4].name).to.eql('datastore-lock: v2.1.0');
        });

...
(0, mocha_1.describe)('PHPYoshi', () => {
    ...
    (0, mocha_1.beforeEach)(async () => {
        ...
        getFileStub
            ...
            .resolves((0, helpers_1.buildGitHubFileRaw)('{"name": "google/client1", "version": "1.2.3"}'));
        getFileStub
    ...
    (0, mocha_1.describe)('buildUpdates', () => {
        (0, mocha_1.it)('builds common files', async () => {
            ...
            (0, helpers_1.assertHasUpdate)(updates, 'VERSION', default_1.DefaultUpdater);
        });
        (0, mocha_1.it)('finds touched components', async () => {
            ...
            (0, helpers_1.assertHasUpdate)(updates, 'Client1/composer.json', root_composer_update_packages_1.RootComposerUpdatePackages);
            (0, helpers_1.assertHasUpdate)(updates, 'Client2/VERSION', default_1.DefaultUpdater);
            (0, helpers_1.assertHasUpdate)(updates, 'Client2/composer.json');
            (0, helpers_1.assertHasUpdate)(updates, 'Client3/VERSION', default_1.DefaultUpdater);
            (0, helpers_1.assertHasUpdate)(updates, 'Client3/composer.json');
        ...
        (0, mocha_1.it)('updates component composer version', async () => {
            const strategy = new php_yoshi_1.PHPYoshi({
                targetBranch: 'main',
                github,
            });
            ...
            const newContent = client1Composer.updater.updateContent('{"name":"google/client1","version":"1.2.3"}');
            (0, chai_1.expect)(newContent).to.eql('{"name":"google/client1","version":"1.2.4"}');
        });
    });
